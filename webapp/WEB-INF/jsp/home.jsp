            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h3>●DB Migration</h3>
                        <p>flyway db migration을 사용했다. db migration은 좀 더 뒤에 구현하려고 했었는데 홈페이지 접속 통계가 문득 궁금해서 listener로 db와 연동하여 금일 접속 통계와 전체 접속 통계를 db를 사용하는 방법 때문에 migration을 사용하게 되었다. 
						그래서 현재 게시판도 db migration을 사용하였다. <br>
						어찌어찌 사용하는 것은 알겠는데 db table생성과 초기 값을 넣어주는 것만 알고 있고 이외에 table 수정등등은 좀 더 공부를 해야한다.</p>
