                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol>
                        	...
                        	아이디와 비밀번호는 정보가 없기때문에 null값을 저장 가능하게 하였습니다.</li>
                        	...
                        	<li>hashmap으로 JSON정보를 가져올까 고민했지만 클래스로 받는것을 택하였습니다.</li>
                        	...
                        	<li>//RowMapper의 구조는 리팩토링하면서 구현</li>
                        ...
                        <ol>
                        	...
                        	<li>정보를 수정하면 네이버 프로필에는 적용되지 않습니다.</li>
                        </ol>
